...
class ProdukItem(models.Model):
    ...
    gambar1 = models.ImageField(upload_to='product_pics')
    gambar2 = models.ImageField(upload_to='product_pics')
    gambar3 = models.ImageField(upload_to='product_pics')
    ...
    def get_add_single_item_to_cart_url(self):
        return reverse("toko:add-single-item-to-cart", kwargs={
            "slug": self.slug
        })
    ...
    def get_remove_single_item_from_cart_url(self):
        return reverse("toko:remove_single_item_from_cart", kwargs={
            "slug": self.slug
            })
